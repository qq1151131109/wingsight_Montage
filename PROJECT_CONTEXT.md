# wingsight_montage - Shared Project Context
...
wingsight_montage is an AI-orchestrated video production platform.
...
Layer 2: skills/                    → "How wingsight_montage uses them" (project conventions)
...
| `skills/core/hyperframes.md` | Layer 2 — when wingsight_montage should pick HyperFrames vs Remotion, artifact → workspace mapping |
