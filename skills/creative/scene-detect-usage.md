# Scene Detection Usage for wingsight_montage
...
- Good default for wingsight_montage explainers where Manim segments are static but live-action may have motion
