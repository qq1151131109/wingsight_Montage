"""Bridge wingsight_montage playbooks → HyperFrames-friendly style artifacts.

wingsight_montage playbooks are YAML files describing visual_language, typography,
...
def _render_design_md(
    ...
    lines = [
        title,
        "",
        f"> Generated by wingsight_montage HyperFrames style bridge (source: {source_note}).",
        "",
        "## Colors",
        "",
