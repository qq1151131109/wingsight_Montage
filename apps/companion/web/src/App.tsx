...
export default function App() {
  ...
  const isHiddenUserModePage = isWingsightUserMode && !isSessionView && route.page !== "playground";
  ...
  if (isHiddenUserModePage) {
    window.location.hash = currentSessionId ? `#/session/${currentSessionId}` : "#/";
    return null;
  }
