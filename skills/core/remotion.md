...
**This file** teaches how wingsight_montage uses Remotion — which compositions map to pipeline
...
| wingsight_montage Artifact | Remotion Prop | Maps To |
|---------------------|---------------|---------|
...
| wingsight_montage Profile | Remotion Config |
|--------------------|-----------------|
