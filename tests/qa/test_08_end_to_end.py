...
SECTIONS = [
    ...
    ("s4_climax",  "Climax", 38, 50, "This is not science fiction. wingsight_montage orchestrates AI tools into a complete video pipeline."),
    ...
    "entries": [
        {
            ...
            "metadata_used": {
                ...
                "hashtags": ["#AI", "#VideoProduction", "#wingsight_montage"],
                "chapters": [
                    {"time": "0:00", "label": "Hook"},
                    {"time": "0:08", "label": "The Problem"},
                    {"time": "0:20", "label": "The Solution"},
                    {"time": "0:38", "label": "wingsight_montage"},
